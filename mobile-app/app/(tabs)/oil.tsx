      ...
      >
        ...
        >
            ...
            <TouchableOpacity activeOpacity={0.8} style={styles.card}>
              <BlurView intensity={30} tint="light" style={styles.cardBlur}>
                ...
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.cardSubtitle}>Estimate your cinnamon oil yield</Text>
                </View>
            ...
            <TouchableOpacity activeOpacity={0.8} style={styles.card}>
              <BlurView intensity={30} tint="light" style={styles.cardBlur}>
                ...
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.cardSubtitle}>Track and optimize drying time</Text>
                </View>
                <MaterialCommunityIcons name="chevron-right" size={26} color="#A0A0A0" />
              </BlurView>
            </TouchableOpacity>
            ...
            <TouchableOpacity activeOpacity={0.8} style={styles.card}>
              <BlurView intensity={30} tint="light" style={styles.cardBlur}>
                ...
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.cardSubtitle}>Monitor your distillation progress</Text>
                </View>
                <MaterialCommunityIcons name="chevron-right" size={26} color="#A0A0A0" />
              </BlurView>
            </TouchableOpacity>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>Empowering Cinnamon Farmers with AI</Text>
          </View>
        </ScrollView>
      </ImageBackground>
    </>
