...
curl http://192.168.50.203:8000/health
```
...
> ⚠️ **For Android Emulator**: The mobile app automatically uses `http://10.0.2.2:8000` for Android emulators and `http://192.168.50.203:8000` for iOS simulators.
...
> 3. Test backend accessibility: `curl http://192.168.50.203:8000/health`
